        ...
        <div>
          ...
          <div className="relative h-full mt-6 pl-[56px]" id="info">
            <div>
              ...
              <div className="lg:mt-20 flex flex-col-reverse lg:flex-row lg:gap-[90px]">
                <div className="mt-4 lg:mt-0">
                  <CustomImage
                ...
                <div className="relative mt-[35px] lg:mt-0">
                  <div className=" bg-[#FCF9F0] w-[58px] h-[58px] flex justify-center items-center rounded-full absolute left-[-62px] lg:left-[-108px] z-10">
                    <div className="text-[25px] bg-[#F8F1DF] w-[44px] h-[44px] flex justify-center items-center rounded-full">
                      02
                    </div>
                  </div>
